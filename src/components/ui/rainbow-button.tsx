...
export function RainbowButton({
  ...
  return (
    <button
      className={cn(
        `group relative inline-flex h-11 animate-rainbow cursor-pointer items-center
        justify-center rounded-xl border-0 bg-[length:200%] px-8 py-2 font-medium
        text-white transition-colors [background-clip:padding-box,border-box,border-box]
        ...
        before:w-3/5 before:-translate-x-1/2 before:animate-rainbow
